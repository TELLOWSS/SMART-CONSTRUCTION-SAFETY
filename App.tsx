    ...
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-indigo-100 selection:text-indigo-900 pb-20">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        {(activeTab === 'setup' || activeTab === 'daily') && (
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10 no-print animate-in slide-in-from-bottom-4 duration-500">
            <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
               ...
               <div className="relative z-10">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">총 인건비 합계</p>
                </div>
                <p className="text-3xl font-extrabold text-slate-900 mt-2 tracking-tight">{totalCost.toLocaleString()} <span className="text-lg text-slate-400 font-medium">원</span></p>
              </div>
            </div>
             <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
               ...
               <div className="relative z-10">
                <div className="flex items-center gap-3 mb-2">
                    ...
                    <p className="text-xs font-bold text-slate-500 uppercase tracking-wider">금월 투입 인원</p>
                </div>
                <p className="text-3xl font-extrabold text-slate-900 mt-2 tracking-tight">{workers.length} <span className="text-lg text-slate-400 font-medium">명</span></p>
               </div>
            </div>
             <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-300 relative overflow-hidden group">
               ...
               <div className="relative z-10">
                ...
                <p className="text-3xl font-extrabold text-slate-900 mt-2 tracking-tight">{totalPhotos} <span className="text-lg text-slate-400 font-medium">장</span></p>
               </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'setup' && (
          <div className="space-y-8 animate-in fade-in duration-300">
            ...
            {/* Added details to LaborCostTable */}
             ...
             <div className="p-[10mm] md:p-[15mm] h-full flex flex-col">
                <div className="border-2 border-slate-900 p-1 flex-1">
                  <div className="border border-slate-600 h-full p-8 relative">
                    ...
                    {/* Pass attendance and date info for detailed report */}
                    <LaborCostTable 
                      workers={workers} 
